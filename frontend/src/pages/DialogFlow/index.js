...
import IntegrationModal from "../../components/DialogFlowModal";
  ...
  return (
    <MainContainer>
      <ConfirmationModal
        title={
          deletingUser &&
          `${i18n.t("dialogFlow.confirmationModal.deleteTitle")} ${deletingUser.name
          }?`
        }
      ...
      >
        {i18n.t("dialogFlow.confirmationModal.deleteMessage")}
      </ConfirmationModal>
      <IntegrationModal
        open={userModalOpen}
      ...
      />
      <MainHeader>
        <Title>{i18n.t("dialogFlow.title")} ({queueIntegration.length})</Title>
        <MainHeaderButtonsWrapper>
          <TextField
            placeholder={i18n.t("dialogFlow.searchPlaceholder")}
            type="search"
            value={searchParam}
        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">{i18n.t("dialogFlow.table.id")}</TableCell>
              <TableCell align="center">{i18n.t("dialogFlow.table.name")}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <>
