...
import IntegrationModal from "../../components/N8nModal";
  ...
  return (
    <MainContainer>
      <ConfirmationModal
        title={
          deletingUser &&
          `${i18n.t("n8n.confirmationModal.deleteTitle")} ${deletingUser.name
          }?`
        }
      ...
      >
        {i18n.t("n8n.confirmationModal.deleteMessage")}
      </ConfirmationModal>
      <IntegrationModal
        open={userModalOpen}
      ...
      />
      <MainHeader>
        <Title>{i18n.t("n8n.title")} ({queueIntegration.length})</Title>
        <MainHeaderButtonsWrapper>
          <TextField
            placeholder={i18n.t("n8n.searchPlaceholder")}
            type="search"
            value={searchParam}
        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">{i18n.t("n8n.table.id")}</TableCell>
              <TableCell align="center">{i18n.t("n8n.table.name")}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <>
