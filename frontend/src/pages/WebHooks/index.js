...
import IntegrationModal from "../../components/WebHooksModal";
  ...
  return (
    <MainContainer>
      <ConfirmationModal
        title={
          deletingUser &&
          `${i18n.t("webHooks.confirmationModal.deleteTitle")} ${deletingUser.name
          }?`
        }
      ...
      />
      <MainHeader>
        <Title>{i18n.t("webHooks.title")} ({queueIntegration.length})</Title>
        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">{i18n.t("webHooks.table.id")}</TableCell>
